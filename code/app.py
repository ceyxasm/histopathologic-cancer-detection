...
st.markdown("The site is equipped with state of the art Machine Learning and Deep Learning model to identify metastatic cancer in image patches taken from pathology scans")
